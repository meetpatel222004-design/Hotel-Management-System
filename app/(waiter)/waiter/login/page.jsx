...
export default function WaiterLogin() {
  ...
  const handleLogin = (e) => {
    ...
    setLoading(true);
    setTimeout(() => {
      dispatch(staffLogin({ role: "waiter", name: "Waiter", staffId: staffId || "W001" }));
    ...
    <Container className="min-h-screen flex items-center justify-center relative">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="glass-strong rounded-3xl p-8 ring-glow">
          ...
          <h1 className="text-2xl font-bold text-center mb-1">Waiter Login</h1>
          <p className="text-sm text-muted-foreground text-center mb-6">Serve orders and help customers</p>
